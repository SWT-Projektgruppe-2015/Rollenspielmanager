...
public class CharaktermanagerController {
    ...
    private void initializeFaehigkeitenList() {
        ...
        faehigkeitenListView_.getSelectionModel().selectedItemProperty()
    ...
    private void removePlayerFromGroup() {
        Spieler chosenSpieler = this.playersInGroupListView_
    ...
    private Spieler getSelectedSpieler() {
        int selectedIndex = playersListView_.getSelectionModel()
                .getSelectedIndex();
        if (selectedIndex < 0)
            return null;
        
        Spieler selectedSpieler = playersListView_.getItems()
                .get(selectedIndex);
